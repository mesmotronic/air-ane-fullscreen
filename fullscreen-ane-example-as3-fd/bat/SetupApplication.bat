...
:: Android packaging
set AND_CERT_NAME="AndroidFullScreenTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndroidFullScreenTest.p12
...
set IOS_PROVISION=cert\AndroidFullScreenTest.mobileprovision
...
set APP_ID=com.mesmotronic.ane.fullscreen.test

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AndroidFullScreenTest
